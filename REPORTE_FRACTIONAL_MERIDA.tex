...
\begin{titlepage}
    ...
    {\Huge\bfseries\color{verdeoscuro} PROYECTO DE COMERCIALIZACIÓN\\[0.5cm]}
    ...
    \begin{tcolorbox}[colback=grisclaro,colframe=turquesa,width=0.8\textwidth]
        \centering
        \textbf{\large Información Clave}\\[0.5cm]
        \begin{tabular}{rl}
            \textbf{Inversión por Ticket:} & \MXN{900000} \\[0.2cm]
            \textbf{Número de Tickets:} & 4 copropietarios \\[0.2cm]
            \textbf{Derechos de Uso:} & 13 semanas/año por ticket \\[0.2cm]
...
El modelo está \textbf{listo para implementación} con todos los elementos de análisis, planificación y documentación necesarios para su exitoso desarrollo.
